...
lambdas = 5:5:30;
mses_convex = zeros(6,1);
for i = 1:6
    [xhat, vhat, res_norm_hist] = srls_GMC_imaging(y, 'matrix completion', lambdas(i), mask=mask, gamma=0, acceleration ='aa2', splitting='FB', tol_stop=1e-4);
