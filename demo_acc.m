X = randn(100,200);
beta = [ones(10,1);zeros(190,1)];
y = X*beta + 0.5*randn(100,1)*std(X*beta);
groups = cell(100,1);
for i=1:100
...
%%
tic
[xhat1, vhat1, res_norm_hist1] = srls_GMC_acc(y, X, 0.01, 'type', 'single', 'acceleration', 'original',"splitting","FB",'gamma',0.8);
toc
tic 
[xhat2, vhat2, res_norm_hist2] = srls_GMC_acc(y, X, 0.01, 'type', 'single', 'acceleration', "original","splitting","FB",'gamma',0.8);
toc
tic 
[xhat3, vhat3, res_norm_hist3] = srls_GMC_acc(y, X, 0.01, 'type', 'single', 'acceleration', "aa2","splitting","FB",'gamma',0.8);
toc
tic 
[xhat4, vhat4, res_norm_hist4] = srls_GMC_acc(y, X, 0.02, 'type', 'single', 'acceleration', "aa2","splitting","FBF",'gamma',0.8);
toc
figure;
