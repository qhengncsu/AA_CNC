...
for i = 1:length(lambda1_range)
    for j = 1:length(lambda2_range)
        ...
        for k = 1:n_folds
            ...
            [xhat_DY, res_norm_hist_DY] = cvxmin(A, b, mu, z0, app, 'lambda1', lambda1_range(i), 'lambda2', lambda2_range(j),...
...
[xhat_DY, res_norm_hist_DY] = cvxmin(A, b, mu, z0, app, 'lambda1', best_lambda1, 'lambda2', best_lambda2,...
                                                 'max_iter', 1e4, 'acceleration', 'original', 'splitting', 'DY');
Xhat = reshape(xhat_DY, [p, L]);                                         
