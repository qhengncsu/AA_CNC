...
csvwrite('times_cnc.csv',times_cnc)
csvwrite('mses_validation_cnc.csv',mses_validation_cnc)
csvwrite('mses_test_cnc.csv',mses_test_cnc)
csvwrite('res_norm_hist_cnc_aa2.csv',res_norm_hist)