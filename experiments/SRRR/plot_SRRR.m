...
title(['DR, $\lambda_1 = $', num2str(lambda1), ', $\lambda_2 = $', num2str(lambda2)], 'Interpreter','latex')
...
xlabel('iteration');
ylabel('residual norm (log scale)');
title(['DY, $\lambda_1 = $', num2str(lambda1), ', $\lambda_2 = $', num2str(lambda2)], 'Interpreter','latex')
l = legend('show','Location','northeast','fontsize',10)