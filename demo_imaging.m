...
tic
for i=1:12
    [xhat1, vhat1, res_norm_hist1] = srls_GMC_imaging(y, 'deblurring', lambdas(i), H=H, gamma=0.98, acceleration = 'aa2', splitting='FB');
    snr_cnc1(i) = snr(x,xhat1-x);
end
toc
tic
for i=1:12
    [xhat2, vhat2, res_norm_hist2] = srls_GMC_imaging(y, 'deblurring', lambdas(i), H=H, gamma=0.98, acceleration = 'aa2', splitting='FBF');
