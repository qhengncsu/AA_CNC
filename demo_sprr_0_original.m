...
for i = 1:length(lambda1_range)
    for j = 1:length(lambda2_range)
        ...
        for k = 1:n_folds
            ...
            Xhat = srls_GMC_sprr(Y_train, X_train, lambda1_range(i), lambda2_range(j), 'acceleration', 'original', 'gamma', 0);
...
Xhat = srls_GMC_sprr(Y_meta_train, X_meta_train, best_lambda1, best_lambda2, 'acceleration', 'original', 'gamma', 0);
